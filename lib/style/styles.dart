...
class Styles {
  static const _defaultTextStyle =
      TextStyle(fontWeight: FontWeight.w500, fontFamily: 'helea');
  ...
  /** 
   * ? Definir Metodo claro en el sistema
   * @param context
   */
  ThemeData setWhiteTheme(BuildContext context) {
    return ThemeData(
        ...
        appBarTheme:
            const AppBarTheme(backgroundColor: Colors.blue, elevation: 0));
  }

  /** 
   * ? Definir Metodo oscuro en el sistema
   * @param context
   */
  ...
  /** 
   * ? Definir Metodo otros en el sistema
   * @param context
   * @param mColor
   * @param color
   */
